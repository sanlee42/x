...
13. After implementation, record attempt evidence:
    ...
    ```
14. Spawn a reviewer subagent for native review only after attempt evidence exists:
    ```bash
