...
- Optional root-facing interactions may happen before architect execution. Configurable interaction role cards such as `strategy`, `technical`, `product`, `challenger`, `architect`, or project-defined roles produce advisory turns, formal role briefs, and proposals for root decision-making.
