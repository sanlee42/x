...
- Optional root-facing interactions may happen before architect execution. Configurable participant cards such as `founder`, `cto`, `product-lead`, `market-intelligence`, `gtm`, `challenger`, or project-defined participants produce advisory turns, formal participant briefs, and proposals for root decision-making.
